	...
	<div class="col-md-3 wow fadeInRight">
		<div class="page-header">
			...
			<div class="form-group">
				...
				<asp:TextBox ID="teacherNo" runat="server"  CssClass="form-control" placeholder="请输入教师工号"></asp:TextBox>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<asp:TextBox ID="comeDate"  runat="server" CssClass="form-control" placeholder="请选择入职日期" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>
			</div>
