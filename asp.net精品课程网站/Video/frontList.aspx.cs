...
public partial class Video_frontList : System.Web.UI.Page
{
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("frontList.aspx?title=" + title.Text.Trim()  + "&&courseObj=" + courseObj.SelectedValue.Trim() + "&&teacherObj=" + teacherObj.SelectedValue.Trim()+ "&&videoTime=" + videoTime.Text.Trim());
        }
