...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">精品课程</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <!--<li><a href="<%=basePath %>Student/frontlist.aspx">学生</a></li>
                <li><a href="<%=basePath %>ClassInfo/frontlist.aspx">班级</a></li>-->
                <li><a href="<%=basePath %>Teacher/frontlist.aspx">师资力量</a></li>
                <li><a href="<%=basePath %>Course/frontlist.aspx">课程</a></li>
                <li><a href="<%=basePath %>Practice/frontlist.aspx">实践</a></li>
                <li><a href="<%=basePath %>TextBook/frontlist.aspx">教材</a></li>
                <li><a href="<%=basePath %>Leaveword/frontlist.aspx">答疑</a></li>
                <li><a href="<%=basePath %>Video/frontlist.aspx">视频录像</a></li>
                <li><a href="<%=basePath %>Thesis/frontlist.aspx">论文列表</a></li>
                <li><a href="<%=basePath %>Reward/frontlist.aspx">获奖记录</a></li>
                <li><a href="<%=basePath %>Kejian/frontlist.aspx">课件下载</a></li>
                <li><a href="<%=basePath %>WebLink/frontlist.aspx">友情链接</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>Student/frontAdd.aspx"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Leaveword/frontUserAdd.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我要提问留言</a></li>
                        <li><a href="<%=basePath %>Leaveword/frontUserList.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我提交的留言</a></li>
                        <li><a href="<%=basePath %>Student/frontSelfModify.aspx"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;修改个人资料</a></li>
