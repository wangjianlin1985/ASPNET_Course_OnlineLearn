		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#leavewordListPanel" aria-controls="leavewordListPanel" role="tab" data-toggle="tab">留言答疑列表</a></li>
			    	<li role="presentation" ><a href="frontAdd.aspx" style="display:none;">添加留言答疑</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>留言id</td><td>留言问题</td><td>留言人</td><td>留言时间</td><td>答疑回复</td><td>答疑时间</td><td>操作</td></tr>
				    					<asp:Repeater ID="RpLeaveword" runat="server">
 										...
 										<tr>
 											...
 											<td><%#GetStudentuserObj(Eval("userObj").ToString())%></td>
	...
	<div class="col-md-3 wow fadeInRight">
		<div class="page-header">
			...
			<div class="form-group">
				<label for="leaveTitle">留言问题:</label>
				<asp:TextBox ID="leaveTitle" runat="server"  CssClass="form-control" placeholder="请输入留言问题"></asp:TextBox>
			</div>
            <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;留言答疑信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="leaveword_leaveTitle_edit" class="col-md-3 text-right">留言问题:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="leaveword_leaveTitle_edit" name="leaveword.leaveTitle" class="form-control" placeholder="请输入留言问题">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="leaveword_replyContent_edit" class="col-md-3 text-right">答疑回复:</label>
		  	 <div class="col-md-9">
			    <textarea id="leaveword_replyContent_edit" name="leaveword.replyContent" rows="8" class="form-control" placeholder="请输入答疑回复"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="leaveword_replyTime_edit" class="col-md-3 text-right">答疑时间:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="leaveword_replyTime_edit" name="leaveword.replyTime" class="form-control" placeholder="请输入答疑时间">
			 </div>
		  </div>
		</form> 
