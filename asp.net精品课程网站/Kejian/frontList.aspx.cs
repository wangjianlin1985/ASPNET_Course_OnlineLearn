...
using System.Data;
public partial class Kejian_frontList : System.Web.UI.Page
{
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("frontList.aspx?title=" + title.Text.Trim()  + "&&courseObj=" + courseObj.SelectedValue.Trim()+ "&&addTime=" + addTime.Text.Trim());
        }
