...
namespace chengxusheji.Admin
{
    public partial class ClassInfoList : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("ClassInfoList.aspx?classNo=" + classNo.Text.Trim() + "&&className=" + className.Text.Trim()+ "&&bornDate=" + bornDate.Text.Trim()+ "&&mainTeacher=" + mainTeacher.Text.Trim());
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            sb.Append("<thead><tr><th colSpan='4'>班级记录</th></tr>");
