...
<body>
   <form id="form1" runat="server">
    <div class="div_All">
    <div class="Body_Title">课程实践管理 》》课程实践列表</div>
     <div class="Body_Search">
        实践的课程&nbsp;&nbsp;<asp:DropDownList ID="courseObj" runat="server"></asp:DropDownList>  &nbsp;&nbsp;
        实践主题&nbsp;&nbsp;<asp:TextBox ID="title" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
        实践时间&nbsp;&nbsp; <asp:TextBox ID="praticeTime"  runat="server" Width="112px" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>&nbsp;&nbsp;
    ...
    <asp:Repeater ID="RpPractice" runat="server" onitemcommand="RpPractice_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><%#Eval("practiceId")%> </td>
                  <td align="center"><%#GetCoursecourseObj(Eval("courseObj").ToString())%></td>
                <td align="center"><%#Eval("title")%> </td>
                <td align="center"><%#Eval("place")%> </td>
                  <td align="center"><%# Convert.ToDateTime(Eval("praticeTime")).ToShortDateString() + " " + Convert.ToDateTime(Eval("praticeTime")).ToLongTimeString() %></td>
