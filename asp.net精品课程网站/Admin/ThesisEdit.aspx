<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ThesisEdit.aspx.cs" Inherits="chengxusheji.Admin.ThesisEdit" %>
...
<body>
    <form id="form1" runat="server">
        <div class="div_All">
    <div class="Body_Title">论文管理 》》编辑论文</div>
        <hr />
        <table cellspacing="1" cellpadding="2">
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button ID="BtnThesisSave" runat="server" Text=" 保存信息 "
