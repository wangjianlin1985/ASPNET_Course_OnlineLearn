...
<body>
   <form id="form1" runat="server">
    <div class="div_All">
    <div class="Body_Title">留言答疑管理 》》留言答疑列表</div>
     <div class="Body_Search">
        留言问题&nbsp;&nbsp;<asp:TextBox ID="leaveTitle" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><%#Eval("leaveTitle")%> </td>
                  <td align="center"><%#GetStudentuserObj(Eval("userObj").ToString())%></td>
