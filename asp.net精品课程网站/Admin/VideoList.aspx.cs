...
namespace chengxusheji.Admin
{
    public partial class VideoList : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("VideoList.aspx?title=" + title.Text.Trim()  + "&&courseObj=" + courseObj.SelectedValue.Trim() + "&&teacherObj=" + teacherObj.SelectedValue.Trim()+ "&&videoTime=" + videoTime.Text.Trim());
        }
