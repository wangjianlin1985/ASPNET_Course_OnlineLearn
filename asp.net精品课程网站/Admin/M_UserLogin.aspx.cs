    ...
    public partial class M_UserLogin : System.Web.UI.Page
    {
        ...
        protected void BtnLogin_Click(object sender, EventArgs e)
        {
            if (CheckNull())
            {
                ...
                int userType = int.Parse(rblcustype.SelectedValue.Trim());
                ENTITY.CusUsers userlogin = new ENTITY.CusUsers(uID, pwdMd5, userType);
                ...
                { 
                    ...
                    Session["IsCusAdmin"] = userType.ToString();
                    ...
                    if (userType.ToString() == "0")
                    {
                        ...
                        bool success = BLL.bllTeacher.ulogin(uID, txtU_Pass.Value);
                        if (success)
                        {
