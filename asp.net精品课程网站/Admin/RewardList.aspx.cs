...
namespace chengxusheji.Admin
{
    public partial class RewardList : System.Web.UI.Page
    {
        ...
        protected void BtnAllDel_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(HSelectID.Value.Trim()))
            {
                try
                {
                    ...
                    {
                        Common.ShowMessage.Show(Page, "suess", "信息成功删除..", "RewardList.aspx");
                    }
                    else
                    {
        ...
        protected void RpReward_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "Del")
            {
                try
                {
                    ...
                    {
                        Common.ShowMessage.Show(Page, "seuss", "信息删除成功...", "RewardList.aspx");
                    }
                    else
                    {
                        Common.ShowMessage.Show(Page, "seuss", "信息删除失败，请重试或联系管理人员...", "RewardList.aspx");
                    }
                }
                catch
                {
                    Common.ShowMessage.Show(Page, "seuss", "删除失败...", "RewardList.aspx");
                }
            }
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            sb.Append("<thead><tr><th colSpan='4'>获奖记录</th></tr>");
            sb.Append("<tr class='title'>");
            sb.Append("<th>获奖id</th>");
            sb.Append("<th>获奖原因</th>");
            sb.Append("<th>获奖的老师</th>");
            sb.Append("<th>获奖时间</th>");
            sb.Append("</tr></thead>");
            sb.Append("<tbody>");
