   ...
   <form id="form1" runat="server">
    ...
    <div class="Body_Title">教师管理 》》教师列表</div>
     <div class="Body_Search">
        教师工号&nbsp;&nbsp;<asp:TextBox ID="teacherNo" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
        教师姓名&nbsp;&nbsp;<asp:TextBox ID="teacherName" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
        入职日期&nbsp;&nbsp; <asp:TextBox ID="comeDate"  runat="server" Width="112px" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>&nbsp;&nbsp;
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><img src="../<%#Eval("teacherPhoto")%>" width=50 height=50 />
                  <td align="center"><%# Convert.ToDateTime(Eval("comeDate")).ToShortDateString() %></td>
