...
namespace chengxusheji.Admin
{
    public partial class LeavewordList : System.Web.UI.Page
    {
        ...
        private void BinduserObj()
        {
            ...
            DataSet userObjDs = BLL.bllStudent.getAllStudent();
        ...
        public string GetStudentuserObj(string userObj)
        {
            return BLL.bllStudent.getSomeStudent(userObj).name;
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            sb.Append("<thead><tr><th colSpan='6'>留言答疑记录</th></tr>");
            sb.Append("<tr class='title'>");
            sb.Append("<th>留言id</th>");
            sb.Append("<th>留言问题</th>");
            sb.Append("<th>留言人</th>");
            sb.Append("<th>留言时间</th>");
            sb.Append("<th>答疑回复</th>");
            sb.Append("<th>答疑时间</th>");
            sb.Append("</tr></thead>");
            sb.Append("<tbody>");
            for (int i = 0; i < leavewordDataSet.Tables[0].Rows.Count; i++)
            {
                ...
                sb.Append("<td>" + BLL.bllStudent.getSomeStudent(dr["userObj"].ToString()).name + "</td>");
