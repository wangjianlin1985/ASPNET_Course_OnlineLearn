...
namespace chengxusheji.Admin
{
    public partial class ThesisList : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("ThesisTeacherAdd.aspx");
        }
        ...
        protected void BtnAllDel_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(HSelectID.Value.Trim()))
            {
                try
                {
                    ...
                    {
                        Common.ShowMessage.Show(Page, "suess", "信息成功删除..", "ThesisTeacherList.aspx");
                    }
                    else
                    {
        ...
        protected void RpThesis_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "Del")
            {
                try
                {
                    ...
                    {
                        Common.ShowMessage.Show(Page, "seuss", "信息删除成功...", "ThesisTeacherList.aspx");
                    }
                    else
                    {
                        Common.ShowMessage.Show(Page, "seuss", "信息删除失败，请重试或联系管理人员...", "ThesisTeacherList.aspx");
                    }
                }
                catch
                {
        ...
        {
            Response.Redirect("ThesisTeacherList.aspx?lwmc=" + lwmc.Text.Trim() + "&&qkmc=" + qkmc.Text.Trim() + "&&fbrq=" + fbrq.Text.Trim() + "&&teacherObj=" + Session["Customername"].ToString() + "&&shzt=" + shzt.Text.Trim());
        }
