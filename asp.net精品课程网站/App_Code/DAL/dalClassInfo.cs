...
namespace DAL
{
    ...
    public class dalClassInfo
    {
        ...
        {
            string sql = "insert into ClassInfo(classNo,className,bornDate,mainTeacher,classMemo) values(@classNo,@className,@bornDate,@mainTeacher,@classMemo)";
            /*构建sql参数*/
            ...
            parm[2].Value = classInfo.bornDate; //成立日期
            parm[3].Value = classInfo.mainTeacher; //班主任
            parm[4].Value = classInfo.classMemo; //班级备注
        ...
        {
            string sql = "update ClassInfo set className=@className,bornDate=@bornDate,mainTeacher=@mainTeacher,classMemo=@classMemo where classNo=@classNo";
            /*构建sql参数信息*/
            SqlParameter[] parm = new SqlParameter[] {
             new SqlParameter("@className",SqlDbType.VarChar),
             new SqlParameter("@bornDate",SqlDbType.DateTime),
            ...
            parm[1].Value = classInfo.bornDate;
            parm[2].Value = classInfo.mainTeacher;
            parm[3].Value = classInfo.classMemo;
            parm[4].Value = classInfo.classNo;
            /*执行更新*/
            return (DBHelp.ExecuteNonQuery(sql, parm) > 0) ? true : false;
        }
